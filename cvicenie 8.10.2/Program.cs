...
namespace cvicenie_8._10_
{
    internal class Program
    {
                    ...
                    case "has":
                        {
                            ...
                            bool hasnumberint = HasNumber(list, numberint);
                            if (hasnumberint)
                            {
        ...
        public static void DelNumber(List<int> list)
        {
        ...
        public static void DelIndex(List<int> list)
        {
        ...
        public static bool HasNumber(List<int> list, int num)
        {
            bool has = false;
        ...
        public static void CountNumber(List<int> list)
        {
            int sum = 0;
            foreach (int i in list)
            {
